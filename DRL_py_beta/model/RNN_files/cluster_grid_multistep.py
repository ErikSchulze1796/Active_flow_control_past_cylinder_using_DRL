...
from model.process_data import EnvironmentStateDataset_from_variable, MinMaxScaler, eval_multistep_model, sliding_windows_single_trajectory
from model.RNN_files.Seq2SeqLSTM import Encoder, Decoder
from model.RNN_files.train_Seq2SeqLSTM import train_LSTM
from model.process_data import load_trajectory_data, create_random_feature_label_data, set_n_pressure_sensors, eval_model_metrics
...
if __name__ == '__main__':
    ...
    train_mode = True
    hidden_size_list = [50]
    layer_number_list = [1,2,3,4,5]
    batch_size_list = [256]
    n_epochs = 10000
    lr = 0.001
    n_p_keep = 16
    input_size = n_p_keep + 1
    seq_length_features_list = [10]
    seq_length_labels = 5
    is_bidirectional = False
    location = "training_pressure_model/initial_trajectories/data_train/initial_trajectory_data_train_set_pytorch_ep100_traj992_t-p400-cd-cl-omega.pt"
    ...
    for batch_size in batch_size_list:
        for seq_length_features in seq_length_features_list:
            for layer_number in layer_number_list:
                for hidden_size in hidden_size_list:
                    ...
                    save_model_path = "training_pressure_model/LSTM/multi_step/grid/" + save_model_folder
                    ...
                    location = "training_pressure_model/initial_trajectories/data_test/initial_trajectory_data_test_set_pytorch_ep100_traj992_t-p400-cd-cl-omega.pt"
