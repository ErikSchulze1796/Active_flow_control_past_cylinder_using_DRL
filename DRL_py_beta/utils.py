...
class utils():
    """
    This class implements general utility functions for working with the DRL directory
    """
    def get_snapshot_List(self, simulation_re=100):
        ...
        snapshotList = glob(f'**/env/base_case/baseline_data/Re_{simulation_re}/processor0/*/')#, recursive=True)
